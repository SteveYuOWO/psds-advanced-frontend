...
export class InsertOneTeacherRecord extends Component {
    constructor() {
        super()
        this.state = {
            teaNum: "",
    ...
    submitTeacherRecord = () => {
        this.setState({loading: true}, () => {
            ...
            TeacherApi.insertOneTeacher(teacher).then((res) => {
                alert(res.data)
            }).then(() => {
                ...
                <div className="model-card shadow" id="add-model-card">
                    <div className="model-card-container">
                        ...
                        <div className="input-group mb-2">
                            ...
                            <input type="text" name="teaNum" className="form-control" placeholder="teaNum"
                                   onChange={this.changeTeaNum}/>
                        </div>
                        <div className="input-group mb-2">
                            <div className="input-group-prepend">
                                <div className="input-group-text">
                    ...
                    <div className="row mbem-3">
                        <div className="col-md-6">
                            <button className="steve-sm-btn" type="submit" onClick={this.submitTeacherRecord}>添加
                            </button>
                        </div>
                        <div className="col-md-6">
...
export default InsertOneTeacherRecord
